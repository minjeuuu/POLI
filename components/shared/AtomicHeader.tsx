        ...
        <div className="flex-none h-16 bg-white/95 dark:bg-stone-900/95 backdrop-blur-md border-b border-stone-200 dark:border-stone-800 flex items-center justify-between px-6 z-50 shadow-sm print:hidden">
            <div className="flex items-center gap-4">
                ...
                <div className="overflow-hidden">
                    <h1 className="font-serif font-bold text-lg text-academic-text dark:text-stone-100 max-w-[200px] md:max-w-md">{title}</h1>
                    {subtitle && <span className="font-mono text-[10px] font-bold uppercase tracking-widest text-academic-gold block">{subtitle}</span>}
                </div>
            </div>
