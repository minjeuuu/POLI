    ...
    try {
        if (mode === 'signup') {
            ...
            const newUser = {
                ...
                password: formData.password, // Note: Local DB only, hashing recommended for production
                level: 1,
                xp: 0,
                coins: 100,
                joinedDate: new Date().toISOString(),
               ...
               <div className="p-6 md:p-8">
                   ...
                   <form onSubmit={handleSubmit} className="space-y-4">
                       ...
                       <button 
                        type="submit" 
                        disabled={loading}
                        className="w-full py-4 bg-academic-accent dark:bg-indigo-600 text-white font-bold uppercase tracking-widest text-xs rounded-xl hover:bg-stone-800 dark:hover:bg-indigo-700 transition-all flex items-center justify-center gap-2 mt-4"
                       >
                   ...
                   <div className="mt-8 flex flex-col items-center space-y-4 border-t border-stone-200 dark:border-stone-800 pt-6">
                       ...
                       <div className="flex gap-4 w-full">
                           <button 
                               ...
                               disabled={loading}
                               className="flex-1 flex items-center justify-center gap-2 bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 py-3 rounded-xl text-xs font-bold shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all active:translate-y-0"
                           >
