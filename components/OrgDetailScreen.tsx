                      ...
                      {data.leadership.map((leader, i) => (
                          <div key={i} className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 p-6 rounded-xl shadow-sm">
                              <div className="flex items-center gap-4 mb-3">
                                  ...
                                  <div>
                                      <h4 className="font-serif font-bold text-lg text-academic-text dark:text-stone-100">{leader.name}</h4>
                       ...
                       {filteredMembers.map((member, i) => (
                           ...
                           >
                               ...
                               <div className="min-w-0">
                                   <span className="block text-xs font-serif font-bold text-stone-800 dark:text-stone-200 group-hover:text-academic-accent dark:group-hover:text-indigo-400 transition-colors">{member.name}</span>
                                   <span className="block text-[9px] uppercase text-stone-400 dark:text-stone-500 tracking-wide">{member.role || 'Member'}</span>
                               </div>
                           </button>
                       ))}
                   </div>
