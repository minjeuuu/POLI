          ...
          <div className="flex-1 p-4 flex flex-col justify-between">
              <div>
                  <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-[9px] font-bold uppercase tracking-widest text-stone-400 dark:text-stone-500">{country.status}</span>
                  </div>
                  <h3 className="font-serif font-bold text-base text-academic-text dark:text-stone-100 leading-tight group-hover:text-academic-accent dark:group-hover:text-indigo-400 transition-colors">
                      {country.name}
                  </h3>
              </div>
          </div>
  ...
  const renderListItem = (country: any, i: number) => (
      ...
      >
          ...
          <div className="flex-1 min-w-0">
              <h3 className="font-serif font-bold text-sm text-academic-text dark:text-stone-100 group-hover:text-academic-accent dark:group-hover:text-indigo-400">{country.name}</h3>
    ...
    <div className="h-full flex flex-col bg-academic-bg dark:bg-stone-950 relative overflow-hidden transition-colors duration-500" onClick={() => setActiveMenu(null)}>
      ...
      <div className="flex-none px-6 pt-6 pb-4 space-y-4 bg-academic-bg/95 dark:bg-stone-950/95 backdrop-blur-xl z-20 border-b border-academic-line dark:border-stone-800 transition-colors duration-500 shadow-sm sticky top-0">
          ...
          <div className="flex gap-2">
              <div className="relative flex-1 shadow-sm group focus-within:shadow-md transition-shadow rounded-xl overflow-hidden bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 focus-within:border-academic-accent dark:focus-within:border-indigo-500">
                  <div className="absolute left-0 top-0 bottom-0 w-12 flex items-center justify-center border-r border-stone-100 dark:border-stone-800">
                      <Search className="w-5 h-5 text-stone-400 dark:text-stone-500 group-focus-within:text-academic-accent dark:group-focus-within:text-indigo-400 transition-colors" />
                  </div>
                  <input 
                    type="text" 
                    ...
                    className="w-full pl-14 pr-10 py-3 bg-white dark:bg-stone-900 outline-none font-serif text-sm text-stone-700 dark:text-stone-200 placeholder:text-stone-400 dark:placeholder:text-stone-600 transition-colors"
                  />
              </div>
              
              <button 
                onClick={() => setSortOrder(prev => prev === 'asc' ? 'desc' : 'asc')}
                className="px-4 bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl flex items-center justify-center hover:border-academic-accent dark:hover:border-indigo-500 transition-colors group text-stone-400 hover:text-academic-accent dark:hover:text-indigo-400"
                title="Sort Order"
              >
              ...
              <button 
                ...
                className={`px-4 bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl flex items-center justify-center hover:border-academic-accent dark:hover:border-indigo-500 transition-colors group
