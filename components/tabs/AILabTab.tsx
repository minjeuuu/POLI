...
import { 
    ...
    MonitorPlay, FileAudio, FileVideo, ScanEye
} from 'lucide-react';
import { 
...
const AILabTab: React.FC = () => {
    const [activeTool, setActiveTool] = useState<string>('veo');

    const tools = [
        { id: 'veo', label: 'Veo Studio', icon: Video, desc: 'Generate videos from text & images' },
        { id: 'nano', label: 'Nano Banana', icon: Wand2, desc: 'Edit images with natural language' },
        { id: 'pro-image', label: 'Pro Image Lab', icon: ImageIcon, desc: 'High-fidelity image generation' },
        { id: 'live', label: 'Live Debate', icon: Mic, desc: 'Real-time voice conversation' },
        { id: 'think', label: 'Deep Thinker', icon: Brain, desc: 'Complex reasoning & analysis' },
        { id: 'analyst', label: 'Media Analyst', icon: ScanEye, desc: 'Analyze images & videos' },
        { id: 'transcribe', label: 'Transcriber', icon: Mic, desc: 'Audio to text' },
        { id: 'tts', label: 'TTS Studio', icon: FileAudio, desc: 'Text-to-Speech synthesis' },
        { id: 'search', label: 'Grounded Search', icon: Search, desc: 'Google Search grounded AI' },
        { id: 'maps', label: 'Grounded Maps', icon: MapIcon, desc: 'Location-aware AI' },
    ];
        ...
        <div className="h-full flex flex-col bg-stone-50 dark:bg-stone-950 overflow-hidden">
            ...
            <div className="p-6 border-b border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 flex items-center justify-between">
                <div>
                    ...
                    <p className="text-stone-500 dark:text-stone-400 text-sm">Experimental features powered by Google DeepMind</p>
                </div>
            </div>
