                    ...
                    ></iframe>
                     <div className="absolute bottom-0 left-0 w-full p-6 pb-12 md:pb-6 z-20 flex items-end justify-between pointer-events-none">
                          <div className="flex-1 max-w-2xl pr-12 pointer-events-auto">
                              ...
                              <p className="text-white/90 text-sm md:text-base font-serif mb-4">{reel.content}</p>
                          </div>
                     </div>
                </div>
            ))}
                        ...
                        {filteredFeed.map((post) => (
                            ...
                            >
                                ...
                                <div className="px-6 py-2">
                                    ...
                                    <p className={`font-serif text-stone-600 dark:text-stone-300 leading-relaxed text-sm transition-all`}>
