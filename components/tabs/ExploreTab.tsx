                                            ...
                                            {section.items.map((item: any, i: number) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="overflow-hidden flex-1">
                                                        <h4 className="text-sm font-bold text-stone-700 dark:text-stone-300 group-hover:text-academic-text dark:group-hover:text-white">{item.name}</h4>
                                    ...
                                    {filteredList.map((item: any, i: number) => (
                                        ...
                                        >
                                            ...
                                            <div className="relative z-10 mt-auto">
                                                <h4 className="font-serif text-sm font-bold text-academic-text dark:text-stone-200 leading-snug group-hover:text-academic-accent dark:group-hover:text-indigo-400 transition-colors">{item.name}</h4>
