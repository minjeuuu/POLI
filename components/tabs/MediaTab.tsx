          ...
          {getFilteredData().map((item, i) => (
              ...
              >
                  ...
                  <div className="flex flex-col justify-center flex-1">
                      ...
                      <h3 className="font-serif text-sm font-bold text-academic-text dark:text-stone-100 mb-1 leading-tight group-hover:text-academic-accent dark:group-hover:text-indigo-400 transition-colors">{item.title}</h3>
                  </div>
              </div>
          ))}
      </div>
