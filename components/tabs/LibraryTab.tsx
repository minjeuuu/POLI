                                    ...
                                    <div className="p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                                        {section.items.map((item, i) => (
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <h4 className="text-sm font-bold text-stone-800 dark:text-stone-200 group-hover:text-academic-text dark:group-hover:text-white leading-snug font-serif mb-1">{item.title}</h4>
                                                    <div className="flex items-center justify-between text-[10px] text-stone-500 dark:text-stone-400 font-mono uppercase tracking-wider">
                                                        <span className="max-w-[70%]">{item.author}</span>
                                                        <span>{item.year}</span>
                                                    </div>
                                                </div>
