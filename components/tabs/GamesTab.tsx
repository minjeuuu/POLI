                    ...
                    {filteredLibrary.slice(searchQuery || activeCategory !== 'All' ? 0 : 3, displayLimit).map((game) => (
                        ...
                        >
                            <div>
                                ...
                                <h4 className="font-bold text-sm text-stone-800 dark:text-stone-200 leading-tight mb-2 group-hover:text-academic-accent transition-colors">{game.title}</h4>
                                <p className="text-[10px] text-stone-500 dark:text-stone-400 leading-relaxed">{game.description}</p>
                            </div>
