...
import { ArrowLeft, Scale, Users, FileText, Anchor, BookOpen, Clock, Fingerprint, Compass, Zap, Search, Printer, TriangleAlert, Building2, Eye, MapPin, CheckCircle, XCircle } from 'lucide-react';
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-white dark:bg-stone-900 p-6 rounded-2xl border border-stone-200 dark:border-stone-800 shadow-sm print:border-black">
                            ...
                            <ul className="space-y-2 text-sm font-serif text-stone-600 dark:text-stone-300 italic">
                                {(Array.isArray(data.questions) ? data.questions : []).map((d: string, i: number) => <li key={i}>"{d}"</li>)}
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className=" space-y-8">
                        ...
                        <div className="bg-academic-paper dark:bg-stone-800/50 p-8 rounded-2xl border border-academic-line dark:border-stone-700 print:bg-stone-100 print:border-black">
                            <h3 className="text-xl font-serif font-bold border-b border-academic-line dark:border-stone-800 pb-2 text-stone-900 dark:text-white mb-6 flex items-center gap-3"><Scale className="w-6 h-6 text-stone-500" /> Precedent & Legal Impact</h3>
