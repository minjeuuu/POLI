...
const EventDetailScreen: React.FC<EventDetailScreenProps> = ({ eventName, onClose, isSaved, onToggleSave, onNavigate }) => {
  ...
  return (
    <div className="fixed inset-0 top-16 z-[60] bg-academic-bg dark:bg-stone-950 flex flex-col animate-in slide-in-from-right duration-500">
          ...
          <div className="flex items-center justify-between px-6 h-16">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h2 className="font-serif font-bold text-lg text-academic-text dark:text-stone-100 max-w-[200px] sm:max-w-md">{data.title}</h2>
                </div>
            </div>
