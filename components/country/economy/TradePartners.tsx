...
export const TradePartners: React.FC<{ data: EconomyProfile, onNavigate?: (type: string, payload: any) => void }> = ({ data, onNavigate }) => {
        ...
        <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl p-6 mt-8">
            ...
            <div className="flex flex-wrap gap-3">
                {data.partners.map((partner, i) => (
                    <div key={i} onClick={() => onNavigate && onNavigate('Country', partner.country)} className="cursor-pointer hover:border-academic-gold transition-colors flex items-center gap-2 p-2 border border-stone-100 dark:border-stone-800 rounded bg-stone-50 dark:bg-stone-900/50">
