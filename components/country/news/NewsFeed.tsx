        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {news.map((item, i) => (
                <div key={i} className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 p-5 rounded-xl shadow-sm hover:shadow-md transition-all cursor-pointer group">
                    ...
                    <h4 className="font-serif font-bold text-sm text-stone-800 dark:text-stone-200 mb-2 group-hover:text-academic-gold transition-colors leading-snug">{item.headline}</h4>
