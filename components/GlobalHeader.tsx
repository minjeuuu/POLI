...
const GlobalHeader: React.FC<GlobalHeaderProps> = ({ toggleTheme, isDark, onNavigate }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 pt-[env(safe-area-inset-top)] box-content bg-white/70 dark:bg-stone-950/70 backdrop-blur-2xl border-b border-stone-200/50 dark:border-stone-800/50 z-[100] shadow-sm transition-colors duration-500">
