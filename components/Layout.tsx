...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, onTabChange, onNavigate, themeMode = 'Default', userPrefs }) => {
  ...
  return (
    <div className={`flex flex-col h-[100dvh] w-[100dvw] transition-colors duration-500 overflow-hidden ${themeClasses} overscroll-none`}>
      <NetworkStatus />
      
      {/* Container for the app to allow background to flow behind headers securely */}
      <div className="absolute inset-0 z-0 bg-academic-bg dark:bg-stone-950 transition-colors duration-500" />
